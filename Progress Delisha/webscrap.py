...
for i in range(len(Document)):
    dictionary = {'title':titles[i],'jumlah':length[i],'cosine':cosine[i],'kalimat':nltk.tokenize.sent_tokenize(Document[i][0])}
...
for i in sort:
    print(i['title'])
    print(i['jumlah'])
    kemiripan = (float(i['cosine']))*100
    print(str("%.2f" % kemiripan) + '%')
    print(i['kalimat'][0])
    print("\n")
